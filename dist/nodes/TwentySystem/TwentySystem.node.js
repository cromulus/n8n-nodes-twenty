...
const inputSchema = {
    ...
    properties: {
        resource: {
            type: 'string',
            description: 'The system resource type to operate on (e.g., workflow, webhook, apiKey, view, connectedAccount, workspaceMember)'
        },
        operation: {
            type: 'string',
...
exports.TwentySystem = TwentySystem;
//# sourceMappingURL=TwentySystem.node.js.map