...
const createSchema = zod_1.z.object({
    resource: zod_1.z.string().describe('The CRM resource type to create (e.g., companies, people, attachments)'),
...
const createManySchema = zod_1.z.object({
    resource: zod_1.z.string().describe('The CRM resource type to create multiple records for'),
...
const updateSchema = zod_1.z.object({
    resource: zod_1.z.string().describe('The CRM resource type to update'),
...
const getSchema = zod_1.z.object({
    resource: zod_1.z.string().describe('The CRM resource type to retrieve'),
...
const getManySchema = zod_1.z.object({
    resource: zod_1.z.string().describe('The CRM resource type to query'),
...
const deleteSchema = zod_1.z.object({
    resource: zod_1.z.string().describe('The CRM resource type to delete from'),
