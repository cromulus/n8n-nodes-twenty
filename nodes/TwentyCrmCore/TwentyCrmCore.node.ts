...
// Zod schemas for AI Tool input validation - CRM Core
const createSchema = z.object({
	resource: z.string().describe('The CRM resource type to create (e.g., companies, people, attachments)'),
...
const createManySchema = z.object({
	resource: z.string().describe('The CRM resource type to create multiple records for'),
...
const updateSchema = z.object({
	resource: z.string().describe('The CRM resource type to update'),
...
const getSchema = z.object({
	resource: z.string().describe('The CRM resource type to retrieve'),
...
const getManySchema = z.object({
	resource: z.string().describe('The CRM resource type to query'),
